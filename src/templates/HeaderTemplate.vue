<template>
    <header class="row d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top text-center bg-dark">
        <div class="p-1 col-sm-4">
            <router-link to="/">
                <img class="img-fluid" src="./img/binco-logo.png"/>
            </router-link>
        </div>
        <div class="p-1 col-sm-4">
